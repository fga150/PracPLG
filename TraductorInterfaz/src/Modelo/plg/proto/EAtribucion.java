...
import Modelo.es.ucm.fdi.plg.evlib.Atribucion;
import Modelo.es.ucm.fdi.plg.evlib.Atributo;
import Modelo.es.ucm.fdi.plg.evlib.LAtributo;
import Modelo.es.ucm.fdi.plg.evlib.SemFun;
import Modelo.es.ucm.fdi.plg.evlib.TAtributos;

import Modelo.Procedimientos.CodigoProcs;
import Modelo.TablaSimbolos.TablaSimbolos;
import Modelo.Tipos.CompruebaTipos;
import Modelo.Tipos.Tipo;
import Modelo.Tipos.TipoArray;
import Modelo.Tipos.TipoBasico;
import Modelo.Tipos.TipoConstante;
import Modelo.Tipos.TipoElemTupla;
import Modelo.Tipos.TipoError;
import Modelo.Tipos.TipoParametro;
import Modelo.Tipos.TipoSubprograma;
import Modelo.Tipos.TipoTupla;
